...
# Create dummy user
user1 = User(name="Kannapiran R", email="kannapiranr@udacity.com",
             picture='https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAVlAAAAJDgxYmM1YzMxLTdhYzktNDYwMy1hZDJlLWI1NDdiZTVjNmQ3Mw.jpg')
session.add(user1)
session.commit()
